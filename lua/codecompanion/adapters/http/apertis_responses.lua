...
---@class CodeCompanion.HTTPAdapter.ApertisResponses: CodeCompanion.HTTPAdapter
return {
  name = "apertis_responses",
  formatted_name = "Apertis responses API",
  roles = {
    llm = "assistant",
    user = "user",
    tool = "tool",
  ...
  url = "https://api.apertis.ai/v1/responses",
  env = {
  ...
  available_tools = {
    ["web_search"] = {
      ...
      enabled = true,
      ---@param self CodeCompanion.HTTPAdapter.ApertisResponses
  ...
  schema = {
    model = {
      ...
      choices = {
        ["gpt-5-nano-2025-08-07"] = { formatted_name = "GPT-5 Nano", opts = { has_function_calling = true, has_vision = true, can_reason = true }, },
        ["gpt-5.1-codex-max"] = { formatted_name = "GPT-5.1-Codex-Max", opts = { has_function_calling = true, has_vision = true, can_reason = true }, },
      },
    },
    ["reasoning.effort"] = {
      order = 2,
